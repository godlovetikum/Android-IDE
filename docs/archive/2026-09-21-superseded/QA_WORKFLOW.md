...
2. Read the root `../README.md` and `PROJECT_PLAN.md` — confirm the active phase and next task
...
Every architectural decision must be recorded in `PROJECT_PLAN.md` before implementation begins.
