...
# Android IDE — Approved Product Definition

**Status:** Approved product definition. This document defines the product to build; it is not a description of the current implementation and does not authorize source-code changes.
